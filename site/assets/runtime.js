...
(function(){
  ...
  function logoHTML(cls){return '<img src="/assets/logo-96.png" alt="CarNimbus" class="'+(cls||'wm-mark')+'" width="26" height="26">';}
  var CAR_IMGS={
  ...
  var R={
    ...
    BottomTabBar:function(el){var val=a(el,'value','feed');
      ...
      return '<div class="tabbar">'+['feed','matches','profile'].map(function(t){return '<div class="tab'+(t===val?' on':'')+'"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">'+(I[t]||I.chat||'')+'></svg>'+t+'</div>';}).join('')+'</div>';}
  };
  function upgrade(){
    var guard=0;
    ...
    document.querySelectorAll('img[src=""]:not([id])').forEach(function(i){i.remove();});   // keep id'd app images (#v-img/#c-img) — JS fills them
...
"Enter your mobile number.":"Ingresa tu número de celular.","We'll text you a code to get started.":"Te enviamos un código para empezar.","New or returning — takes about a minute.":"Nuevo o recurrente — toma cerca de un minuto.","HOBBIES":"PASATIEMPOS","YOUR PASSES":"TUS PASES","No passes yet — book a test drive to get your first Drive Now pass.":"Aún no tienes pases — agenda una prueba de manejo para obtener tu primer pase Drive Now.","Est. loan amount":"Monto estimado del préstamo","Est. APR":"TAE estimada","Loan partners:":"Prestamistas:","(sample)":"(muestra)","· SOFT-CHECKED":"· VERIFICADO","YOUR ESTIMATE":"TU ESTIMADO","These are estimates based only on the information you provided. CarNimbus isn't responsible for inaccurate details you enter — we estimate your rate from your inputs and our dealer & lender partners. Your final terms are confirmed at signing.":"Estos son estimados basados solo en la información que proporcionaste. CarNimbus no se responsabiliza por datos inexactos que ingreses — estimamos tu tasa con tus datos y nuestros socios prestamistas. Tus términos finales se confirman al firmar.","No new matches — adjust your budget in Profile.":"Sin nuevos matches — ajusta tu presupuesto en Perfil.","No conversations yet — talk to a match to start one.":"Aún no hay conversaciones — habla con un match para empezar.","Loading…":"Cargando…","Open full →":"Abrir completo →","Talk →":"Hablar →","Ask me anything — or tell me when you want to drive.":"Pregúntame lo que sea — o dime cuándo quieres manejar.","🎉 You're booked — see your pass in Profile.":"🎉 Estás agendado — ve tu pase en Perfil.","Locating…":"Ubicando…","CarNimbus AI":"CarNimbus IA","Copied to share.":"Copiado para compartir.","Drivetrain":"Tracción","APR (soft-checked)":"TAE (verificada)","Book a Live Demo →":"Reserva una demo en vivo →","Sponsored":"Patrocinado","Sign in →":"Iniciar sesión →","sign in →":"iniciar sesión →",
"Match":"Match","Garage":"Garaje","YOUR GARAGE":"TU GARAJE","YOUR VEHICLE":"TU VEHÍCULO","Est. trade-in":"Intercambio est.","💬 Ask the Feed":"💬 Pregúntale al Feed","Sponsored · Dealer ad":"Patrocinado · Anuncio","YOUR ESTIMATE":"TU ESTIMADO","Est. APR":"TAE est.","HOBBIES":"PASATIEMPOS","YOUR FINANCES":"TUS FINANZAS","Color":"Color","Other details":"Otros detalles","Engine":"Motor","Transmission":"Transmisión","Range":"Autonomía","Seats":"Asientos","Trim":"Versión","Body":"Carrocería","Miles":"Millas","Near you":"Cerca de ti","Everyone":"Todos","Use my location":"Usar mi ubicación","Locating…":"Ubicando…","↗ Share":"↗ Compartir","💬 Reply":"💬 Responder","Be the first — say something about a car you talked to.":"Sé el primero — comenta sobre un auto con el que hablaste.","Feed unavailable — refresh to retry.":"Feed no disponible — actualiza para reintentar.","No new matches — adjust your budget in Garage.":"Sin nuevos matches — ajusta tu presupuesto en Garaje.","🎉 You're booked — see your pass in Garage.":"🎉 Estás agendado — ve tu pase en Garaje.","Edit my car →":"Editar mi auto →",
"VALUE SCORE":"PUNTUACIÓN DE VALOR","GROSS ATTRIBUTED":"GANANCIA ATRIBUIDA","AVG DAYS TO CLOSE":"DÍAS PROM. AL CIERRE","VEHICLE":"VEHÍCULO","ROUTED":"ENVIADOS","SHOWED":"ASISTIERON","SOLD":"VENDIDOS","Nimbus take":"Opinión de Nimbus","Ideal for:":"Ideal para:","Your go-to body style":"Tu carrocería favorita","In your click range":"En tu rango de precio","You keep coming back to this":"Sigues volviendo a este"} };
  ...
  function wireAppNav(){
    ...
    // Corner language toggle and gesture icon for consumer app paths
    if(hideChrome){
      var langBtn = document.getElementById("cn-corner-lang");
      if(!langBtn){
        langBtn = document.createElement("button");
        langBtn.id = "cn-corner-lang";
        langBtn.type = "button";
        langBtn.style.cssText = "position:fixed;top:12px;right:12px;z-index:999;background:rgba(6,16,40,.8);border:1px solid rgba(24,200,255,.3);color:#fff;font:700 11.5px Manrope;padding:5px 9px;border-radius:8px;cursor:pointer;backdrop-filter:blur(8px);box-shadow:0 0 10px rgba(24,200,255,.1)";
      ...
      // Floating back arrow for detail pages if header is hidden
      if(/\/(car|talk|edit-profile|pass)/.test(here) && !document.getElementById("cn-corner-back")){
        var bkBtn = document.createElement("button");
        bkBtn.id = "cn-corner-back";
        bkBtn.type = "button";
    ...
    // Single shared /api/me for the whole page — page JS reuses window.__me instead of re-fetching.
    window.__me=fetch("/api/me").then(function(r){return r.json();});
    window.__me.then(function(d){
