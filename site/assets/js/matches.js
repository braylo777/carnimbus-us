  ...
  loadMatches().then(function(d){
    ...
    el.innerHTML=cars.map(function(c){
      return '<div class="glass" data-id="'+c.id+'" data-slug="'+slug(c)+'" style="cursor:pointer;flex:none;width:150px;border-radius:14px;overflow:hidden;scroll-snap-align:start">'+
        ...
        (c.fitScore!=null?'<div style="font:700 8px Manrope;color:#18C8FF;background:rgba(24,200,255,.1);border-radius:6px;padding:3px 6px;margin-bottom:5px">⚡ '+esc(c.fitScore)+'/100 fit</div>':'')+
